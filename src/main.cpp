...
unsigned int nStakeTargetSpacing = 4 * 60;		// 4 minutes block spacing

int64 nChainStartTime = 1406991918;
...
const string strMessageMagic = "B2Bcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 32;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in B2Bcoin
    bool fStrictPayToScriptHash = true; // Always active in B2Bcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "B2Bcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Bussiness 2 Bussiness";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1406991918;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2723023;
		if(fTestNet)
        {
            block.nNonce   = 1469;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc10597614003352475357a536945f9f220ad11c6234061555e075bebba3c83bd"));
...
unsigned char pchMessageStart[4] = { 0x20, 0x35, 0x22, 0xdb };
